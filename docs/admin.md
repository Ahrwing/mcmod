...
此处可以查看、移动、搜索、重命名Mod内的资料；对于物品/方块资料，可附有和并、综合的操作。

注：此处的资料是指[官方文档](http://mcmod.readthedocs.io/zh/latest/data/)内资料类型中的所有类型，它们都可以在此处更改。

想要查看Mod的某个资料类型里的资料，应选择Mod与资料类型，之后就会显示出此Mod相应资料类型下的所有资料；如果你是在查看`物品/方块`类型下的资料，那么还应相应选择其内部分类。之后就会显示里面资料的ID、名称、小图标、资料摘要和操作。操作对于全体资料都可以有选择、编辑和删除，对物品/方块资料，可附有选中且和并、综合或更改分类的操作。具体情况如图：
...
`□不显示参与“合并”或“综合”的资料`选中之后不会出现 被 和并/综合 到的物品和 和并/综合 在上的物品，当然这些都只对`物品/方块`类型起效。

---

（以下功能都是针对物品/方块资料，不再特殊说明）

想要将一堆资料结合起来，那么可以使`和并`和`综合`功能，二者的区别可以看下图：

![](https://admin.mcmod.cn/assets/img/diff.png)

和并是：有一堆子物品，那么选一个子物品并让其他的子物品结合到上面，这是和并；

综合是：有一堆子物品，编辑员随之添加一个父物品，那么把子物品结合到父物品上面，这是综合。

和并功能的介绍可以去[百科文档-资料添加/编辑教程-仅编辑员](https://mcmod.readthedocs.io/zh/latest/data/#_7)处查看；下面会介绍综合功能。
...
想要和并物品，首先应该选中想要和并上的物品，然后左上方就会显示`选择项和并至物品ID`，将选择的首物品的物品ID填入，然后点击`和并`按钮并等待和并完成。
